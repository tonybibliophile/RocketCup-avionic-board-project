...
void EXTI4_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(LORA920_INT_Pin);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(INT_HIGHG2_Pin);
  HAL_GPIO_EXTI_IRQHandler(LORA920_BUSY_Pin);
  HAL_GPIO_EXTI_IRQHandler(INT_ACCEL1_Pin);
  HAL_GPIO_EXTI_IRQHandler(INT_ACCEL2_Pin);
  HAL_GPIO_EXTI_IRQHandler(INT_GYRO1_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(INT_MAGN_Pin);
